...
<meta property="og:image" content="{ORIGIN}assets/social-preview.jpg"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{e(title)}"><meta name="twitter:description" content="{e(description)}"><meta name="twitter:image" content="{ORIGIN}assets/social-preview.jpg">
<script type="application/ld+json">{json.dumps(schema,ensure_ascii=False)}</script></head>
<body class="resource-page topic-page textbook-page"><a class="skip-link" href="#main-content">Skip to main content</a>{HEADER}<main id="main-content">{content}</main>{FOOTER}<script src="site.js?v=20260914-1" defer></script><script src="textbook-companions.js" defer></script></body></html>''',path)
...
<section class="textbook-section" id="downloads"><h2>Take the practice into a lesson</h2><p>The printable sheet contains the questions first, followed by hints and full worked solutions. The editable LaTeX source is ready for Overleaf.</p><div class="download-row"><a href="assets/textbook-practice/{s}-practice.pdf">Practice sheet &amp; solutions (PDF)</a><a href="assets/textbook-practice/edexcel-practice-overleaf.zip" download>All six sheets for Overleaf (ZIP)</a></div></section>{tuition()}</div>'''
 (ROOT/filename(b)).write_text(page(filename(b),'Edexcel '+title+(' Solutions' if s.startswith('statistics-mechanics') else ' Textbook Companion & Solutions'),description+' Chapter-by-chapter SolutionBank links and original questions with hints and worked solutions.',content))
...
content=f'''<header class="textbook-hero"><div class="container"><nav class="textbook-breadcrumbs" aria-label="Breadcrumb"><a href="resources.html">All resources</a></nav><p class="topic-kicker">UK Edexcel · A-level &amp; Further Maths</p><h1>Edexcel A-level and Further Maths textbook solutions and practice</h1><p>Your textbook. Practice with a purpose: chapter-by-chapter worked-solution links, original practice checks and guidance for the next step. Choose the book you use in lessons.</p><nav class="topic-jumps" aria-label="Companion shortcuts"><a href="#books">Choose your book</a><a href="#using-the-companions">Plan a practice session</a><a href="maths-topic-practice.html">Topic guides</a></nav></div></header><div class="container"><section id="books" class="textbook-grid" aria-label="Edexcel textbook companions">{cards}</section>
...
(ROOT/'edexcel-textbook-companions.html').write_text(page('edexcel-textbook-companions.html','Edexcel Maths Textbook Solutions & Practice','Find UK Edexcel A-level and Further Maths chapter solutions, original practice checks, printable sheets and guidance for Pure, Statistics, Mechanics and Core Pure.',content,True))
